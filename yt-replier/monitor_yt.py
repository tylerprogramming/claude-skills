...
Uses the official YouTube Data API v3 (via the skill's own OAuth token in auth_yt.py).
...
# Self-contained auth (lives next to this script — no dependency on other skills).
SKILL_DIR = Path(__file__).parent
sys.path.insert(0, str(SKILL_DIR))
from auth_yt import get_service  # noqa: E402
